...
export function BibleProgressCard({ plano }: { plano: PlanoBiblico }) {
  return (
    <Card>
      <h3 className="text-2xl font-black text-[#004B87]">{plano.nome}</h3>
      <p className="mt-2 text-sm font-bold uppercase tracking-wider text-gray-500">Duração de {plano.duracaoMeses} meses</p>
