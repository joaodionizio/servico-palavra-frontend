...
const variants = {
  primary: "bg-[#004B87] text-white hover:bg-[#003366] hover:shadow-lg dark:bg-[#0A5F9F] dark:hover:bg-[#0B4F83]",
  secondary: "bg-gray-100 text-gray-600 hover:bg-[#004B87] hover:text-white dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-[#0A5F9F]",
  ghost: "text-gray-500 hover:bg-blue-50 hover:text-[#004B87] dark:text-slate-300 dark:hover:bg-slate-800 dark:hover:text-[#7BB7F0]",
