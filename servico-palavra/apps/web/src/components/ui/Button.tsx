...
const variants = {
  ...
  secondary: "bg-gray-100 text-gray-600 hover:bg-[#004B87] hover:text-white",
  ghost: "text-gray-500 hover:bg-blue-50 hover:text-[#004B87]",
  gold: "bg-[#FFCC00] text-[#004B87] hover:bg-yellow-400 hover:shadow-lg"
};
